...
::: {.column width="70%"}
&nbsp;
<p style="text-indent:-2em;padding-left:2em;font-size:80%;">O’Sullivan D & L Bergmann. Forthcoming. Tiled and woven patterns for multivariate mapping. _Annals of the American Association of Geographers_.</p>
:::
::: {.column width="30%"}
![](images/weavingspace-qr.png){height="250" fig-align="left"}
:::
:::

::: {style="font-size:24px;background-color:#dddddd;position:relative;bottom:50px;"}
...
<p style="text-indent:-2em;padding-left:2em;;font-size:80%;">O’Sullivan D & L Bergmann. 2026. Using _MapWeaver_ to make tiled and woven maps of multivariate thematic data. _Cartographic Perspectives_ **108**. doi: [10.14714/CP108.2109](https://dx.doi.org/10.14714/CP108.2109).</p>


![](images/mapweaver-qr.png){height="250"}
...
![](images/weavingspaceQGIS-qr.png){height="250" style="position:relative;top:20vh;left:0vw;"}
...
[github.com/DOSull/mapweaver](https://github.com/DOSull/mapweaver)
