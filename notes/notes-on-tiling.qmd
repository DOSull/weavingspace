...
| Date       | Changes
|:-          |:-------
| 2026-04-17 | Moved images to local.
...
![](../images/33434-and-cairo.png)(see also [33434 tiles](../examples/example-tiles-33434.ipynb) and [Cairo tiles](../examples/example-tiles-cairo.ipynb))
...
(see ['wobbly-edged' Escherian tiles](../examples/example-tiles-wobbly-escherian.ipynb))
...
+ [Tiled annuli symbols](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-annuli.ipynb)
+ [Arrow head tiles](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-arrows.ipynb)
+ [Cairo tiles](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-cairo.ipynb)
+ [The 3<sup>2</sup>.4.3.4 tiling](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-33434.ipynb)
+ ['Wobbly edged' Escher tiles](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-wobbly-escherian.ipynb)
+ [The 4.8<sup>2</sup> octagonal tiling](https://github.com/DOSull/weavingspace/blob/main/examples/example-tiles-octagons.ipynb)
