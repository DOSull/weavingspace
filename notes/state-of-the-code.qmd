...
Some examples of these can be seen in [this notebook](https://dosull.github.io/weavingspace/examples/topology-working.ipynb), although a less impenetrable interface to applying transformations is likely required.
